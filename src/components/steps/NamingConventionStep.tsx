...
import { ArrowLeft, ArrowRight, BookOpen, Upload, FileText, X } from 'lucide-react';
import { useAppStore } from '@/stores/app-store';
import { cn } from '@/components/ui/cn';

/**
 * Step 2 — Naming Convention Document (optional).
 * User can upload a naming convention document (Excel or Word)
 * or skip this step.
 */
export function NamingConventionStep() {
    ...
    <div className="space-y-8">
      ...
      <div className="text-center">
        ...
        <p className="mx-auto mt-2 max-w-2xl text-sm leading-relaxed text-gray-500 sm:text-base">
          Do you have a standardised naming convention document that you want to follow?
        </p>
      </div>
